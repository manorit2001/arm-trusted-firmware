...
ti_scmi_clock_t clock_table[] = {
	...
	AM62L_SCMI_CLOCK_PARENT(AM62LX_DEV_TIMER1_CLKSEL_VD,
				...
				str(TIMER1_CLKSEL_VD)),
	AM62L_SCMI_CLOCK_MUX(AM62LX_DEV_TIMER1_CLKSEL_VD,
	...
	AM62L_SCMI_CLOCK_PARENT(AM62LX_DEV_TIMER3_CLKSEL_VD,
				...
				str(TIMER3_CLKSEL_VD)),
	AM62L_SCMI_CLOCK_MUX(AM62LX_DEV_TIMER3_CLKSEL_VD,
				AM62LX_DEV_TIMER3_CLKSEL_VD_CLK,
				str(TIMER3_CLKSEL_VD)),
	AM62L_SCMI_CLOCK_PARENT(AM62LX_DEV_WKUP_TIMER1_CLKSEL_VD,
				AM62LX_DEV_WKUP_TIMER1_CLKSEL_VD_CLK_PARENT_GLUELOGIC_HFOSC0_CLK,
				str(WKUP_TIMER1_CLKSEL_VD)),
	AM62L_SCMI_CLOCK_PARENT(AM62LX_DEV_WKUP_TIMER1_CLKSEL_VD,
	...
	AM62L_SCMI_CLOCK_PARENT(AM62LX_DEV_WKUP_TIMER1_CLKSEL_VD,
				...
				str(WKUP_TIMER1_CLKSEL_VD)),
	AM62L_SCMI_CLOCK_MUX(AM62LX_DEV_WKUP_TIMER1_CLKSEL_VD,
